          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border-0 shadow-xl overflow-hidden">
            ...
            <div className="p-8 space-y-6">
              <div className="text-center space-y-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold">1. Arbeitstag bestätigt</h2>
                  <p className="text-sm text-muted-foreground mt-1">{applicantName}, Ihr 1. Arbeitstag wurde erfolgreich gebucht.</p>
                </div>
              </div>
